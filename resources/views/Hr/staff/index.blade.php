                                    ...
                                    <tbody>
                                        @foreach($staffs as $index => $staff) 
                                            <tr>
                                                ...
                                                <td class="col-2">
                                                    <!-- View Button -->
                                                    <a href="{{ route('hr.staff.show',$staff->id) }}" class="btn btn-success btn-sm">
                                                        <i class="fas fa-eye"></i>
                                                    </a>

                                                    <!-- Edit Button -->
                                                    <a href="{{ route('hr.staff.edit',$staff->id) }}" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>

                                                    <!-- Delete Button -->
                                                    <a href="{{ route('hr.staff.delete',$staff->id)}}" id="delete" class="btn btn-danger btn-sm">
