                ...
                <div class="card card-primary card-outline shadow-lg">
                    <div class="card-header py-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('hr.attendance.create') }}" class="btn btn-sm btn-success rounded-0">
                            ...
                            <tbody>
                                @foreach($attendances as $index => $attendance)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- View Button -->
                                            <a href="{{ route('hr.attendance.show', $attendance->id) }}" class="btn btn-success btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="{{ route('hr.attendance.delete', $attendance->id) }}" id="delete" class="btn btn-danger btn-sm">
