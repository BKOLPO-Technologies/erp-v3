                    ...
                    <div class="card card-primary card-outline shadow-lg">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">Edit Stock Inward</h4>
                        ...
                        <form role="form" action="{{ route('inventory.stockinward.update', $stockInward->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <select class="form-control select2 @error('vendor_id') is-invalid @enderror" 
                                            ...
                                            @foreach($vendors as $vendor)
                                                <option value="{{ $vendor->id }}" 
                                                    {{ old('vendor_id', $stockInward->vendor_id) == $vendor->id ? 'selected' : '' }}>
                                        ...
                                        <select class="form-control select2 @error('product_id') is-invalid @enderror" 
                                            ...
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" 
                                                    {{ old('product_id', $stockInward->product_id) == $product->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('total_price') is-invalid @enderror" 
                                               ...
                                               value="{{ old('total_price', $stockInward->total_price) }}" placeholder="Enter total cost" required >
                                        @error('total_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                               ...
                                               value="{{ old('quantity', $stockInward->quantity) }}" placeholder="Enter quantity" required>
                                        @error('quantity')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('unit_price') is-invalid @enderror" 
                                               ...
                                               value="{{ old('unit_price', $stockInward->unit_price) }}" placeholder="Enter unit price" required readonly>
                                        @error('unit_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('comments') is-invalid @enderror" 
                                                  id="comments" name="comments" rows="3" placeholder="Enter comments">{{ old('comments', $stockInward->comments) }}</textarea>
                                        @error('comments')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="1" {{ old('status', $stockInward->status) == '1' ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ old('status', $stockInward->status) == '0' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary float-right">
                                            <i class="fas fa-save"></i> Update Stock Inward
                                        </button>
                                    </div>
                                </div>
                            </div>
