@extends('Inventory.layouts.admin', [$pageTitle => 'Customer View'])
                            ...
                            <div class="row wrapper white-bg page-heading">
                                <div class="col-md-4">
                                    <div class="card card-block p-3">
                                        <h4 class="text-xs-center">{{ $customer->name }}</h4>
                                        ...
                                        <div class="user-button">
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <a href="{{ route('inventory.customer.edit', ['id' => $customer->id ]) }}" class="btn btn-warning btn-sm">
