@extends('Inventory.layouts.admin', ['pageTitle' => 'Customer Edit'])
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline shadow-lg">
              ...
              <!-- form start -->
              <!-- <form role="form"> -->
              <form action="{{ route('inventory.customer.update', $customer->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Group Name" name="company" value="{{ $customer->company }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="number" class="form-control" placeholder="Phone" name="phone" value="{{ $customer->phone }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_account_name" value="{{ $customer->bank_account_name }}" placeholder="Enter Bank Account Name">
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_account_number" value="{{ $customer->bank_account_number }}" placeholder="Enter Bank Account Number">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="bank_routing_number" value="{{ $customer->bank_routing_number }}" placeholder="Enter Roting Number">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="bin" value="{{ $customer->bin }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>TAX ID</label>
                                <input type="number" class="form-control" placeholder="Tax Id" name="taxid" value="{{ $customer->taxid }}">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
