                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary card-outline shadow-lg">
                            ...
                            <div class="card-body">
                              <form method="POST" action="{{ route('expense-category.update',$expensecateory->id) }}" enctype="multipart/form-data">
                                  @csrf
                                  <div class="row">
                                          ...
                                          <div class="input-group">
                                              <span class="input-group-text"><i class="fa fa-check-circle"></i></span>
                                                <select class="form-control" id="status" name="status">
                                                    <option value="1" {{ $expensecateory->status == 1 ? 'selected' : '' }}>Active</option>
                                                    <option value="0" {{ $expensecateory->status == 0 ? 'selected' : '' }}>Inactive</option>
                                                </select>
                                          </div>
                                      </div>
                                  </div>
