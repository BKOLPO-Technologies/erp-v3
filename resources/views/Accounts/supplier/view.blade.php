@extends('Accounts.layouts.admin', ['pageTitle' => 'Vendor View'])
                                ...
                                <div class="col-md-4">
                                    <div class="card card-block p-3">
                                        ...
                                        <div class="user-button">
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <a href="{{ route('accounts.supplier.edit', ['id' => $supplier->id ]) }}" class="btn btn-warning btn-sm">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <a href="{{ route('accounts.supplier.products', $supplier->id) }}" class="btn btn-primary btn-sm">
                                                   View Products Purchases
                                                </a>
                                            </div>
                                        
                                            <div class="col-md-6 text-right">
                                                <a href="{{ route('accounts.supplier.transactions', $supplier->id) }}" class="btn btn-success btn-sm">
                                                    View Transactions
                                                </a>
                                            </div>
                                        </div>
