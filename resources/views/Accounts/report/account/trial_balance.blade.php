                        ...
                        <div class="card-body mt-3">
                            ...
                            <form action="{{ route('accounts.report.trial.balance') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.trial.balance') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
        ...
        "buttons": [
            ...
            },
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.head).find('title').text('Trial Balance Report - {{ get_company()->name ?? "" }}');
                    ...
                    $(win.document.body).prepend(`
                        <div class="text-center mb-2" style="margin-bottom: 10px;">
                            ...
                            <p style="margin: 3px 0; font-weight: bold;">Trial Balance Report</p>
                    ...
                    // REMOVED: The code that adds "Printed on" date at the bottom
                }
            },
        ],
