@extends('Accounts.layouts.admin', ['pageTitle' => 'Day Book Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('accounts.report.daybook') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.daybook') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="card-header text-center mb-3">
                                ...
                                <p class="mb-0"><strong>Day Book Report</strong></p>
                                           ...
                                           <table id="example3" class="table-striped table-bordered" style="width: 100%;">
                                                ...
                                                <tfoot>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($totalDebit, 2) }}</td>
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($totalCredit, 2) }}</td>
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format(abs($totalDebit), 2) }}</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                            <!-- Amount in Words -->
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong class="text-uppercase">{{ convertNumberToWords(number_format(abs($running_balance), 2)) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
