                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('accounts.report.purchases.sales') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.purchases.sales') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example3" class="table-striped table-bordered" style=" width: 100%;">
                                                <thead style="border-bottom: 2px solid black;">
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%;">Invoice No/PO No</th>
                                                        <th style="width: 20%;">Vendor/Client Name</th>
                                                ...
                                                <tbody>
                                                    @foreach($purchasesSalesReports as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">{{ bdt() }} {{ number_format($item['debit'], 2) }}</td>
                                                            <td class="text-end">{{ bdt() }} {{ number_format($item['credit'], 2) }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($purchasesSalesReports->sum('debit'), 2) }}</td>
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($purchasesSalesReports->sum('credit'), 2) }}</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                            ...
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong class="text-uppercase">{{ convertNumberToWords(number_format($purchasesSalesReports->sum('debit'), 2)) }}</strong>
                                            </div>
                                            {{-- <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                <strong>Amount in Words Sales:</strong>
                                                <strong class="text-uppercase">{{ convertNumberToWords(number_format($purchasesSalesReports->sum('credit'), 2)) }}</strong>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
