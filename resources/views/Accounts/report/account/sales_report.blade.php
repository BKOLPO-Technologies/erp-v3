@extends('Accounts.layouts.admin', ['pageTitle' => 'Sales Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('accounts.report.sales') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.sales') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example3" class="table-striped table-bordered" style=" width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach($salesReports as $key => $sales)
                                                        <tr>
                                                            <td class="col-1">{{ $key+1 }}</td>
                                                            <td>{{ $sales['invoice_no'] }}</td>
                                                            <td>{{ $sales['client_name'] }}</td>
                                                            <td>{{ $sales['invoice_date'] }}</td>
                                                            <td class="text-end col-2">{{ bdt() }} {{ number_format($sales['credit'], 2) }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($salesReports->sum('credit'), 2) }}</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
        ...
        "buttons": [
            ...
            },
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.head).find('title').text('Sales Report - {{ get_company()->name ?? "" }}');
                    ...
                    $(win.document.body).prepend(`
                        <div class="text-center mb-2" style="margin-bottom: 10px;">
                            ...
                            <p style="margin: 3px 0; font-weight: bold;">Sales Report</p>
