                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('accounts.report.receipts.payments') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.receipts.payments') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="card-header text-center mb-3">
                                ...
                                <p class="mb-0"><strong>Receipt & Payment Report</strong></p>
