@extends('Accounts.layouts.admin', ['pageTitle' => 'Bills Payable Report'])
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow-lg">
                        ...
                        <div class="card-body mt-3">
                            <!-- Date Filter Form -->
                            <form action="{{ route('accounts.report.bills.payable') }}" method="GET" class="mb-3">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-1 mt-3 d-flex align-items-end">
                                        <a href="{{ route('accounts.report.bills.payable') }}"  class="btn btn-danger w-100">Clear</a>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="card-header text-center mb-3">
                                ...
                                <p class="mb-0"><strong>Bills Payable Report</strong></p>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                                        ...
                                        <div class="table-responsive">
                                            <table id="example3" class="table-striped table-bordered" style=" width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach($billspayableReports as $key => $report)
                                                        <tr>
                                                ...
                                                <tfoot>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($billspayableReports->sum('grand_total'), 2) }}</td>
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($billspayableReports->sum('paid_amount'), 2) }}</td>
                                                        <td class="text-end font-weight-bolder">{{ bdt() }} {{ number_format($billspayableReports->sum('due_amount'), 2) }}</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                            ...
                                            <div id="amountInWordsPrint" style="margin-top: 10px;">
                                                ...
                                                <strong class="text-uppercase">{{ convertNumberToWords(number_format($billspayableReports->sum('grand_total'), 2)) }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        "buttons": [
            ...
            },
            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.head).find('title').text('Bills Payable Report - {{ get_company()->name ?? "" }}');
                    ...
                    $(win.document.body).prepend(`
                        <div class="text-center mb-2" style="margin-bottom: 10px;">
                            ...
                            <p style="margin: 3px 0; font-weight: bold;">Bills Payable Report</p>
