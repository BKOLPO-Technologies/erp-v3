                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary card-outline shadow-lg">
                            ...
                            <div class="card-body">
                              <form method="POST" action="{{ route('accounts.branch.store') }}" enctype="multipart/form-data">
                                  @csrf
                                  <div class="row">
                                  ...
                                  <div class="row mt-3">
                                      <div class="col-lg-12">
                                          <button type="submit" class="btn btn-primary bg-success text-light" style="float: right;"><i class="fas fa-plus"></i> Add Branch</button>
                                      </div>
                                  </div> 
                              </form>
                            </div>
