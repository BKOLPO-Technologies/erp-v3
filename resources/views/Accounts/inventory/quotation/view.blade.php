                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                ...
                                <address>
                                    ...
                                    {{ $quotation->client->address }}, {{ $quotation->client->city }}<br>
                                    {{ $quotation->client->region }}, {{ $quotation->client->country }}<br>
                                    Phone: {{ $quotation->client->phone }}<br>
                                    Email: {{ $quotation->client->email }}
                                </address>
                                </div>
                                <div class="col-sm-4 invoice-col">
                                <b>Invoice :- {{ $quotation->invoice_no }}</b><br>
                                <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                        <th>Discount</th>
                                        <td>{{ bdt() }} {{ number_format($quotation->discount, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <th>Total:</th>
                                        <td>{{ bdt() }} {{ number_format($subtotal - $quotation->discount, 2) }}</td>
                                    </tr>
                                    </table>
                                </div>
                                </div>
