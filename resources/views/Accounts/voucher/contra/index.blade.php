@extends('Accounts.layouts.admin', ['pageTitle' => 'Contra Voucher List'])
@section('admin')
                        ...
                        <div class="card card-primary card-outline shadow-lg">
                            <div class="card-header py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @can('journal-create')
                                    <a href="{{ route('accounts.contra-voucher.create') }}" class="btn btn-sm btn-success rounded-0">
                                        <i class="fas fa-plus fa-sm"></i> Add New Contra Voucher 
                                    </a>
                                    @endcan
                                </div>
                            </div>
                                        ...
                                        @foreach ($journalVouchers as $key => $voucher)
                                            ...
                                            <tr class="{{ $isLatest ? 'bg-success text-white' : 'bg-light' }}">
                                                ...
                                                <td class="col-2">
                                                    ...
                                                    @endcan
                                                    @can('journal-edit')
                                                        <a href="{{ route('accounts.contra-voucher.edit', $voucher->id) }}" class="btn btn-sm btn-warning text-light">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    @endcan
                                                    @can('journal-delete')
                                                        <a id="delete" href="{{ route('accounts.contra-voucher.delete', $voucher->id) }}" class="btn btn-sm btn-danger delete-button">
