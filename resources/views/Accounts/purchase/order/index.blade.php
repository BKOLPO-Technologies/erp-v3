                        ...
                        <div class="card card-primary card-outline shadow-lg">
                            <div class="card-header py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('accounts.purchase.order.create') }}" class="btn btn-sm btn-success rounded-0">
                                        <i class="fas fa-plus fa-sm"></i> Add New Purchase Order
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        @foreach($purchases as $purchase)
                                            <tr>
                                                ...
                                                <td class="col-2">
                                                    ...
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('accounts.purchase.order.edit', $purchase->id) }}" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <!-- Delete Button -->
                                                    <a href="{{ route('accounts.purchase.order.destroy', $purchase->id) }}" id="delete" class="btn btn-danger btn-sm">
...
<script>
    ...
    $(document).ready(function () {
        $('.view-purchase').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('accounts.purchase.order.view') }}",
                type: "GET",
                data: { id: purchaseId },
