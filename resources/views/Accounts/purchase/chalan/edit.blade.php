@extends('Accounts.layouts.admin', ['pageTitle' => 'Out Coming Chalan'])
@section('admin')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary card-outline shadow-lg">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('incoming.chalan.update', $chalan->id ) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 mb-3">
                                    ...
                                    <textarea id="description" name="description" class="form-control" rows="3" placeholder="Enter Note">{{ old('description', $chalan->description) }}</textarea>
                                </div>
                            </div>
