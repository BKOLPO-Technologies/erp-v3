@php
  ...
  // new
  $isTransactionsActive = Route::is('accounts.journal-voucher.*','accounts.purchase.invoice.index','accounts.purchase.invoice.create','accounts.purchase.invoice.show','accounts.purchase.invoice.edit','accounts.purchase.order.index','accounts.purchase.order.create','accounts.purchase.order.edit','accounts.purchase.order.create','accounts.sale.index','accounts.sale.create','accounts.sale.show','accounts.sale.edit','workorders.index','workorders.create','workorders.edit','workorders.show','incoming.chalan.index','accounts.incoming.chalan.create','accounts.incoming.chalan.show','accounts.incoming.chalan.edit','accounts.sale.payment.index','accounts.sale.payment.create','accounts.sale.payment.edit','accounts.stock.in','accounts.stock.in.view', 'accounts.sale.payment.show','accounts.project.receipt.payment.index', 'accounts.project.receipt.payment.create', 'accounts.project.receipt.payment.show','accounts.contra-voucher.create','accounts.contra-voucher.index','accounts.contra-voucher.edit','accounts.project.receipt.payment.edit');
@endphp
