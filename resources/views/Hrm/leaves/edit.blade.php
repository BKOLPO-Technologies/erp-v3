@extends('Hrm.layouts.admin', [$pageTitle => 'Edit Leave Application'])
                    ...
                    <div class="card card-primary card-outline shadow-lg mb-4">
                        <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('hrm.leaves.index') }}" class="btn btn-sm btn-danger rounded-0">
                                    <i class="fa-solid fa-arrow-left"></i> Back To List
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('hrm.leaves.update', $leaveApplication->id) }}" enctype="multipart/form-data">
                                @csrf
