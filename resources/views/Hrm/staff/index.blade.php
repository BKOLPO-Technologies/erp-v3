                        ...
                        <div class="card card-primary card-outline shadow-lg">
                            <div class="card-header py-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('hrm.staff.create') }}" class="btn btn-sm btn-success rounded-0">
                                    ...
                                    <tbody>
                                        @foreach($staffs as $index => $staff) 
                                            <tr>
                                                ...
                                                <td class="col-2">
                                                    <!-- View Button -->
                                                    <a href="{{ route('hrm.staff.show',$staff->id) }}" class="btn btn-success btn-sm">
                                                        <i class="fas fa-eye"></i>
                                                    </a>

                                                    <!-- Edit Button -->
                                                    <a href="{{ route('hrm.staff.edit',$staff->id) }}" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-edit"></i>
                                                    </a>

                                                    <!-- Delete Button -->
                                                    <a href="{{ route('hrm.staff.delete',$staff->id)}}" id="delete" class="btn btn-danger btn-sm">
