@extends('Hrm.layouts.admin', [$pageTitle => 'Create Staff'])
@section('admin')
                    ...
                    <div class="card card-primary card-outline shadow-lg">
                        <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('hrm.staff.list')}}" class="btn btn-sm btn-danger rounded-0">
                                    <i class="fa-solid fa-arrow-left"></i> Back To List Staff
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('hrm.staff.update',$staff->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
